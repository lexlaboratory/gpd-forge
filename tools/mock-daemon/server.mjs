  ...
  if (method === 'GET' && path === '/battery/charge-guard') {
    ...
    return send(res, 200, {
      ...
      advisory:
        ...
        '(docs/adr/0004): no vendor tool implements a charge limit, ACPI declares no _BMC/_BMD, and ' +
        'the EC fields that look like a threshold are never referenced by any firmware method. ' +
        'Guessing an EC register for a charge controller on hardware with no vendor recovery is not ' +
        'a risk worth taking. What this does ' +
